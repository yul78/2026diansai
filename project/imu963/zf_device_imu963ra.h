...
#define IMU963RA_INIT_OK              (0U)
#define IMU963RA_INIT_MAIN_ERROR      (1U)
#define IMU963RA_INIT_MAG_ERROR       (2U)
#define IMU963RA_INIT_ACC_CFG_ERROR   (3U)
#define IMU963RA_INIT_GYRO_CFG_ERROR  (4U)
#define IMU963RA_INIT_MAG_CFG_ERROR   (5U)

extern uint8 imu963ra_device_addr;
extern uint8 imu963ra_who_am_i;
extern uint8 imu963ra_diag_scl_low;
extern uint8 imu963ra_diag_scl_release;
extern uint8 imu963ra_diag_sda_low;
extern uint8 imu963ra_diag_sda_release;
extern uint8 imu963ra_diag_ack_6b;
extern uint8 imu963ra_diag_ack_6a;
extern uint8 imu963ra_diag_who_6b;
extern uint8 imu963ra_diag_who_6a;

//================================================瀹氫箟 IMU963RA 鍩烘湰閰嶇疆================================================
#define IMU963RA_USE_SOFT_IIC                       (1)                         // Use the project's PA12/PB15 software IIC bus.
...
#define IMU963RA_SCL_PIN                            ( IMU963RA_GPIO_SCL )
#define IMU963RA_SDA_PIN                            ( IMU963RA_GPIO_SDA )
//====================================================杞欢 IIC 椹卞姩====================================================
#else
