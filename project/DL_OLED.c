...
#define OLED_W_SCL(x)   do { if (x) DL_GPIO_setPins(OLED_PORT, OLED_OLED_SCL_PIN); else DL_GPIO_clearPins(OLED_PORT, OLED_OLED_SCL_PIN); } while(0)
#define OLED_W_SDA(x)   do { if (x) DL_GPIO_setPins(OLED_PORT, OLED_OLED_SDA_PIN); else DL_GPIO_clearPins(OLED_PORT, OLED_OLED_SDA_PIN); } while(0)

/* I2Cʱ����ʱ��50������ @32MHz �� 1.56?s����ӦԼ320kHz I2C */
#define I2C_DELAY() delay_cycles(125)
...
/**
  * @brief  OLED���ù��λ��?
  * @param  Y �����Ͻ�Ϊԭ�㣬���·��������?��Χ��0~7
  * @param  X �����Ͻ�Ϊԭ�㣬���ҷ��������?��Χ��0~127
  * @retval ��
  */
...
void OLED_Init(void)
{
	delay_cycles(32000 * 100);	//�ϵ���ʱ ~100ms @32MHz
